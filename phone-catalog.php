...
require_once PC_PLUGIN_DIR . 'includes/ai.php';
...
add_action('admin_menu', 'pc_ai_admin_menu');
...
add_filter('wpseo_title', 'pc_yoast_title');
add_filter('wpseo_metadesc', 'pc_yoast_description');
add_filter('wpseo_canonical', 'pc_yoast_canonical');
add_filter('wpseo_opengraph_title', 'pc_yoast_title');
add_filter('wpseo_opengraph_desc', 'pc_yoast_description');
add_filter('wpseo_opengraph_url', 'pc_yoast_canonical');
add_filter('wpseo_twitter_title', 'pc_yoast_title');
add_filter('wpseo_twitter_description', 'pc_yoast_description');
add_filter('wpseo_schema_graph', 'pc_yoast_schema_graph');
add_filter('wpseo_breadcrumb_links', 'pc_yoast_breadcrumb_links');
